...
class Register extends Component{
    ...
    onSubmit(e){
       ...
       /* axios.post('/api/users/register', newUser)
            ...
            .catch(err => this.setState({ errors: err.response.data }));  // .catch(err => console.log(err.response.data));
        console.log(newUser);*/
    }
...
export default connect(mapStateTpProps, {registerUser})(withRouter(Register));